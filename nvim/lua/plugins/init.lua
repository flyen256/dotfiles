return {
	...
	},
	{
		...
		opts = {
			...
			formatters = {
				prettier = {
					args = { "--no-tabs", "--tab-width", "2", "$FILENAME" },
				},
			},
		},
	},
	...
	},
	{
		...
		config = function()
			require("mason").setup()
			local lspconfig = require("lspconfig") -- FIX: Import the plugin correctly
		...
		require("mason-lspconfig").setup({
			...
			handlers = {
				...
				-- Dedicated handler overrides for clangd
				["clangd"] = function()
					lspconfig.clangd.setup({
						capabilities = capabilities,
						init_options = {
							fallbackFlags = {
								"-I", "/usr/include/wlroots-0.21"
							}
						}
					})
				end,
	...
	{ 'nvim-mini/mini.icons', version = false, config = function()
	...
	{ 'akinsho/bufferline.nvim', version = "*",  dependencies = "nvim-mini/mini.icons" },
	{
